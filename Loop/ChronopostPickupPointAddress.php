...
class ChronopostPickupPointAddress extends Address
{
    ...
    {
        $this->exists = AddressChronopostPickupPointQuery::create()->findPK($id) !== null;
    }
    ...
    public function buildModelCriteria()
    {
        ...
        return $this->exists ?
                AddressChronopostPickupPointQuery::create()->filterById($id[0]) :
